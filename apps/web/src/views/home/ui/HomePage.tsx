...
export default function HomePage(){
    ...
    return <div>
        ...
        <section className="container min-h-80 xl:py-24 lg:py-12 md:py-6 px-3 lg:space-y-12">
            <header className="flex justify-between items-start">
                <div className="space-y-3 xl:w-3/5">
                    <h3 className="text-4xl font-semibold text-dark font-sans">Disponible en magasin</h3>
        ...
        <section className="bg-contain h-fit w-full bg-center  relative">
            <div
                className="absolute top-0 -z-10 h-full w-full bg-dark bg-[radial-gradient(#ffffff33_1px,#000000_1px)] bg-[size:20px_20px]"></div>
            ...
            <div className="container min-h-80 xl:py-20 lg:py-8 md:py-6 px-3 lg:space-y-9 grid md:grid-cols-2">
                <aside className="content-center">
                    <div className="space-y-3">
                        <h3 className="text-[68px] text-yellow-500 leading-[100%] font-bold text-start  xl:w-3/5">Service
                            title</h3>
                        <p className="text-md font-light xl:w-3/5 text-start text-white/90">description</p>
                    </div>
                </aside>
                <aside>
                ...
                <aside className="col-span-1 space-y-12">
                    ...
                    <ul className="space-y-6 xl:w-3/5 *:grid *:grid-cols-3 *:h-12 *:items-center *:*:last:col-span-2 *:*:last:font-montserrat-sans pl-1 text-dark">
                        <li className="border-l-3 border-yellow-500 pl-3">
                            <span>Telephone :</span><span>(+237) 675 75 75 30</span>
                        </li>
                        <li className="border-l-3 border-dark pl-3 bg-gray-100">
                            <span>Whatsapp : </span><span>(+237) 655 55 55 90</span>
                        </li>
                        <li className="border-l-3 border-yellow-500 pl-3">
                            <span>Email : </span><span>scvpsd237@yahoo.com</span>
                        </li>
                        <li className="border-l-3 border-dark pl-3 bg-gray-100">
                            <span>Localisation: </span><span>Yaounde, Lycee Bilingue Essos</span>
                        </li>
                        <li className="border-l-3 border-yellow-500 pl-3">
                            <span>Disponibilite: </span><span>Ouvert Lun - Dim / 07h-19h</span>
                        </li>
                    </ul>
                </aside>
