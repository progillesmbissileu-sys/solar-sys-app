...
import { Drawer, DrawerClose, DrawerContent, DrawerTitle } from '@/shared/ui/molecules/Drawer';
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <button
      ...
      {...props}
    >
      <PanelLeft className="size-5 shrink-0 text-gray-700 dark:text-gray-300" aria-hidden="true" />
