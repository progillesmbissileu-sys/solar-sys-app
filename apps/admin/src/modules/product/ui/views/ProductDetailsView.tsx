...
import { RiStockLine, RiPriceTag3Line, RiStore2Line, RiCalendarLine, RiDeleteBinLine, RiPencilLine } from '@remixicon/react';
                  ...
                  >
                    ...
                    {!isSelected && !isMainImage && (
                      <button
                        ...
                        className="absolute top-1 right-1 p-1.5 rounded-full bg-red-500 text-white opacity-0 group-hover:opacity-100 transition-opacity hover:bg-red-600 shadow-lg"
                        title="Delete image"
                      >
                    ...
                    {/* Main image badge */}
                    {isMainImage && (
                      <span className="absolute bottom-1 left-1 px-1.5 py-0.5 text-[10px] font-medium bg-blue-500 text-white rounded">
                        Main
                      </span>
                    )}
                  </div>
                ...
                <div className="flex-1">
                  ...
                  {product.brand && (
                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                      by <span className="font-medium text-gray-700 dark:text-gray-300">{product.brand}</span>
                    </p>
                  )}
                </div>
