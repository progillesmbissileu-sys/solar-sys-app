...
export const productCollection = callAction<void, CollectionResponseType<Product>>(
  '/api/product',
  'get'
);

export const getProduct = callActionWithId<void, { data: Product }>('/api/product/{id}', 'get');
